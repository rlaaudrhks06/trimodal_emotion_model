...
| 지표 | 값 |
|---|---|
| **7클래스 정확도** | v11 46.19% (시드 42; 3시드 45.18 ± 0.96). **최신 v11e s42: 46.51** (v11d + wav2vec2 9~12층 미세조정, 시드 3개 확인 중). 소음 증강 이후 SNR 10dB에서도 46.22 |
| 3클래스(긍정/부정/중립) — 제품이 쓰는 단위 | **68.58%** (재학습 없이 7개 확률을 묶어서 고른 값 — 배포 엔진 방식. argmax만 묶으면 67.34%) |
